...
Compose environment (Lesson 12)
   +
dependency scanning (Lesson 19)
   +
container scanning (Lessons 19-20)
   +
SBOM (Lesson 18)
   +
runtime hardening (Lesson 22)
   +
manual release quality gate (Lesson 25)
   =
...
2. Image signing and provenance were mentioned conceptually in Lesson 24 but not implemented. Why do both genuinely need automation (a pipeline, not a human) to be trustworthy?
