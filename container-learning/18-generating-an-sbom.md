...
3. Both `pip-audit` (Lesson 19) and this SBOM inventory this project's Python dependencies. Are they redundant? What does one give you that the other doesn't?
