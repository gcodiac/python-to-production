...
> The long-form version of [README.md](README.md): why the application is deliberately minimal, what it does and does not contain, and the full journey it is designed to be taken through.
